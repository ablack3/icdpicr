...
<p style="margin-left: 40px">`icd10="TRUE", i10_iss_method="gem_min"`</p><br>

2. Data from US trauma registries coded using only ICD-10-CM : 

<p style="margin-left: 40px">`icd10="cm", i10_iss_method="roc_max_TQIP"`</p><br>
...
<p style="margin-left: 40px">`icd10="cm", i10_iss_method="roc_max_NIS"`</p><br>

5. Data from non-US sources coded using basic ICD-10:

<p style="margin-left: 40px">`icd10="base", i10_iss_method="roc_max_TQIP"` or `icd10="base", i10_iss_method="roc_max_NIS"`</p><br>
