These files were provided by Dave Clark and implement that algorithm use to map ICD 10 codes to AIS using ridge regression and the roc_max method he developed.
